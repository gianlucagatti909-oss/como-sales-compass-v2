...
// PERF: React.memo — these components render once per row in list views (potentially 100+ rows)
export const TrendIcon = memo(function TrendIcon({ trend, size = 16 }: { trend: TrendDirection; size?: number }) {
  switch (trend) {
...
export const CategoryBadge = memo(function CategoryBadge({ cat }: { cat: string | null }) {
...
export const TrendBadge = memo(function TrendBadge({ value }: { value: number | null }) {
